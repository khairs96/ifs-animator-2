...
var IFS_PRESETS = {
  ...
  'koch-snowflake': {
    brightness: 1.1,
    functions: [
      { a: 1 / 3, b: 0, c: 0, d: 1 / 3, e: -0.5, f: -0.2 },
      { a: 0.5 / 3, b: -Math.sqrt(3) / 6, c: Math.sqrt(3) / 6, d: 0.5 / 3, e: -0.166, f: 0.2 },
      { a: 0.5 / 3, b: Math.sqrt(3) / 6, c: -Math.sqrt(3) / 6, d: 0.5 / 3, e: 0.166, f: 0.2 },
      { a: 1 / 3, b: 0, c: 0, d: 1 / 3, e: 0.5, f: -0.2 }
    ]
  },
  'cantor-set': {
    brightness: 0.9,
    functions: [
      { a: 1 / 3, b: 0, c: 0, d: 0.0, e: -0.5, f: 0 },
      { a: 1 / 3, b: 0, c: 0, d: 0.0, e: 0.5 - 1 / 3, f: 0 }
    ]
  },
  'dragon-curve': {
    brightness: 1.0,
